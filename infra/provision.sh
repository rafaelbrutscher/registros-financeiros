...
echo ""
echo -e "${GREEN}┌──────────────────────────────────────────────────────────────┐${NC}"
echo -e "${GREEN}│  provision.sh concluído com sucesso!                         │${NC}"
echo -e "${GREEN}├──────────────────────────────────────────────────────────────┤${NC}"
echo -e "${GREEN}│  Mailpit UI  :  http://177.44.248.118:8025                   │${NC}"
echo -e "${GREEN}│  Homolog     :  http://177.44.248.118:8090  (Fase 4)         │${NC}"
echo -e "${GREEN}│  Prod        :  http://177.44.248.118:8091  (Fase 4)         │${NC}"
echo -e "${GREEN}│  Repositório :  https://github.com/rafaelbrutscher/          │${NC}"
echo -e "${GREEN}│                 registros-financeiros                        │${NC}"
echo -e "${GREEN}├──────────────────────────────────────────────────────────────┤${NC}"
echo -e "${GREEN}│  Próximo passo:                                              │${NC}"
echo -e "${GREEN}│    bash infra/homolog/up.sh                                  │${NC}"
echo -e "${GREEN}│    bash infra/prod/up.sh                                     │${NC}"
echo -e "${GREEN}└──────────────────────────────────────────────────────────────┘${NC}"
echo ""
